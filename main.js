...
// include: /tmp/tmp4pee3pe6.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/main.data';
...
Module['FS_createPath']("/assets", "icon", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_bin/main.data');
      }
      Module['addRunDependency']('datafile_bin/main.data');
    ...
    loadPackage({"files": [{"filename": "/assets/audio/beep.wav", "start": 0, "end": 11972}, {"filename": "/assets/fonts/roboto.ttf", "start": 11972, "end": 180232}, {"filename": "/assets/icon/icon.svg", "start": 180232, "end": 181689}], "remote_package_size": 181689});

  })();

// end include: /tmp/tmp4pee3pe6.js
...
var ASM_CONSTS = {
  316276: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 316491: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 316638: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
